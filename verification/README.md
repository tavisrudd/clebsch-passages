...
```text
python3 verification/evidence/aligned_faithfulness.py --check
python3 verification/evidence/aligned_faithfulness_replay.py
sha256sum -c verification/evidence/aligned_faithfulness.sha256
```
